...
export const Card = () => {
  ...
  const handleClick = () => {
    alert('੭ ᐕ)੭*⁾⁾Congratulations! You have successfully rented!ᕕ( ᐛ )ᕗ');
    window.location.href ="https://www.strikingly.com/s/sites/22833246/preview?mode=seamless&viewMode=screen";
  }
